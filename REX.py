...
\033[92;1m(>  \033[1;37mFacebook      \033[1;32m :\033[1;97m   kiffy 
\033[92;1m(>  \033[1;37mGithub        \033[1;32m : \033[1;97m  kiffy
...
def mang_check():
  ...
  print(logo)
  try: 
    httpCaht = requests.get("https://github.com/Ubermanue/Approve").text 
    if id in httpCaht: 
      ...
      os.system("xdg- open https://www.facebook.com/profile.php?id=61566523670021="+id)
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def admin():
			...
			if YM in ['A','1']:os.system("xdg-open https://xxxx.xxxx.com")				
			if YM in ['B','2']:os.system("xdg-open https://hentai.com ")				
			if YM in ['C','3']:os.system("xdg-open https://porn.com")				
